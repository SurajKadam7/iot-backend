  ...
  return (
    <article className={`widget${waiting ? " waiting" : ""}${flash ? " flash" : ""}`}>
      <header className="widget-head">
        <div>
          <h2>{device.name}</h2>
          <p className="muted">{place || device.device_identifier}</p>
        </div>
      ...
      {waiting ? (
        ...
        <div className="metrics">
          ...
          <div>
            ...
            <div className="metric-value pressure">
          ...
          <div>
            ...
            <div className="metric-value humidity">
      ...
      <footer className="widget-foot">
        <code>{device.device_identifier}</code>
        {reading && (
